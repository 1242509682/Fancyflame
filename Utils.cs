...
public static class Utils
{
	...
	public static int NewProj(Player player, Vector2 position, Vector2 velocity, int Type, int Damage, float KnockBack = 20f, int owner = 255, float ai0 = 0, float ai1 = 0, int extraUpdates = 0)
	{
		var source = player.GetProjectileSource_Item(player.HeldItem);
	...
	public static int NewProjNoBC(Player player, Vector2 position, Vector2 velocity, int Type, int Damage, float KnockBack = 20f, int owner = 255, float ai0 = 0, float ai1 = 0)
	{
		var source = player.GetProjectileSource_Item(player.HeldItem);
		int index = Projectile.NewProjectile(source, position, velocity, Type, Damage, KnockBack, owner, ai0, ai1);
		return index;
